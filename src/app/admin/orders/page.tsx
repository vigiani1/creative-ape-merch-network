      ...
      <div className="mt-6 overflow-x-auto">
        <table className="w-full min-w-[980px] text-left text-sm">
          ...
          <tbody>
            ...
            {!orders?.length ? <tr><td colSpan={7} className="py-12 text-center text-black/45">No orders yet. This page is ready for checkout data when payments are connected.</td></tr> : null}
          </tbody>
        </table>
      </div>
    </div>
